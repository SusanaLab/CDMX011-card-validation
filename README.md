...
Comsumidores de una tienda en linea de bicicletas que desear verificar si su tarjeta es valida para su compra.

* Cuáles son los objetivos de estos usuarios en relación con tu producto.

Validar su tarjeta de credito para comprar en la tienda en linea Bicycle Shop.
Minimizar los pasos para su compra.
Obtener la informacion de manera rapida y sencilla.
Cuidar y manter segura su informacion de tarjeta. 
...
El proyecto busca validar tarjetas de credito mediante el uso del algoritmo de Luhn.

* La imagen final de tu proyecto.
* Investigación UX:
  1. Explicar quiénes son los usuarios y los objetivos en relación con el
    producto.
    El cliente o consumidor inicial de el producto es una Tienda en linea, la cual busca reducir la salida de sus consumidores al momento de hacer su compra el linea en su pagina, ya que al que la pagina no tenga una forma de saber si su tarjeta es valida o no para comprar, el usuario pierde el interes y busca otra tienda que si le ofresca este servicio. 
    Como consecuencia de esto la empresa requiere de un Validador de tarjeta para proporcionarlo a sus consumidores que son:
    Personas interesadas por la adquisicion de una bicicleta, refacciones o equipo en la tienda en linea Bicycle Shop.
    Objetivos:
  ...
  El prototipo inicial se mencionaba el uso de pocisionamiento.
